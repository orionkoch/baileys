...
(function ($) {
    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            if (!itemdata('init')) {
                ...
                itemdata('afterinit', itemdata('afterinit') || options.afterinit);
    ...
    //some default values.
    $.fn.rateit.defaults = { min: 0, max: 5, step: 0.5, starwidth: 16, starheight: 16, readonly: false, resetable: true, ispreset: false, afterinit: false};
